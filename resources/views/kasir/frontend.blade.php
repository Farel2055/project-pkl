        ...
        <div class="w-100">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row row-cols-auto g-4 justify-content-space-between">
                        <div class="col">
                            <a href="{{route('kasir')}}" class="btn btn-success px-4">Baru</a>
                        </div>
                        <div class="col">
                            <a href="{{route('rekapan')}}" class="btn btn-warning text-light px-4">Rekapan</a>
                        </div>
                        <div class="col">
                            <button class="btn btn-primary px-3" data-bs-toggle="modal" data-bs-target="#BayarModal">Bayar</button>
                        </div>
                    </div>
                </div>
                {{-- modal pembayaran--}}
                                ...
                                <div class="modal-body">
                                    <div class="card-body">
                                        ...
                                        <div style="margin-left:22.5rem;" class="pt-2">
                                            <button type="button" class="btn btn-success" id="prosesBayarBtn" onclick="prosesBayar()">Proses</button>
                                        </div>
                                        <div class="d-flex justify-content-between pt-4">
