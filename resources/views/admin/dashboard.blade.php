                ...
                <div class="">
                    ...
                    <div class="d-flex align-items-center justify-content-between pt-4">
                        <div class="">
                            ...
                            <a href="{{route('pembayaran.index')}}" class="btn btn-secondary rounded-5 border-0 px-4">Lihat</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-12 col-lg-4 col-xxl-4 d-flex">
        <div class="card rounded-4 w-100 bg ">
            <div class="card-body"  >
                <div class="">
                    <div class="d-flex align-items-center gap-2 mb-2">
                        <h5 class="mb-0">Jumlah Pelanggan</h5>
                    </div>
                    <div class="d-flex align-items-center justify-content-between pt-4">
                        <div class="">
                            <h3 class="mb-0 text-indigo pb-3">{{$jumlahpembayaran}}</h3>
        ...
        <div class="card rounded-4 w-100">
            <div class="card-body">
                <div class="d-flex align-items-start justify-content-between mb-3">
                    <div class="">
                        <h5 class="mb-0">Daftarkan Kasir</h5>
                    </div>
                    <div class="dropdown">
