            ...
            <form class="row g-3" method="POST" action="{{ route('user.store') }}">
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        <a href="{{route('user.index')}}" class="btn btn-success px-3">Batal</a>
                        <a href="{{route('user.create')}}" class="btn btn-grd btn-danger px-3">Reset</a>
                        <button type="submit" class="btn btn-warning text-light px-3">Simpan</button>
                    </div>
                </div>
            </form>
        </div>
